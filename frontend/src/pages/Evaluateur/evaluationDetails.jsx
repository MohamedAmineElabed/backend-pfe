...
const CritereItem = ({
  ...
  // Allows evaluateur to unlock an already-decided critere for re-evaluation
  ...
  const canBeEvaluated = response && (response.valeur === 2 || response.valeur === 3);
  ...
  // Header accent driven by current state
  const headerBg =
        ...
        {responsesForThisCritere.length > 0 ? (
          responsesForThisCritere.map((r, i) => (
            <div key={i} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              {/* Responsable answer + preuves — side by side */}
              ...
              <div>
                ...
                {isLocked ? (
                  ...
                  <div>
                    ...
                    {/* Re-evaluate button — always shown when response can be evaluated */}
                    {canBeEvaluated && (
          ...
          <p style={{ fontStyle: "italic", color: "#94a3b8", fontSize: 13 }}>
